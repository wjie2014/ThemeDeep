...
public class ThemeUtils {
    ...
    public static int getPrimaryColor(Context context) {
        PreferenceUtils SP = PreferenceUtils.getInstance(context);
    ...
    public void updateSwitchColor(SwitchCompat sw, int color){
        ...
        sw.getTrackDrawable().setColorFilter(sw.isChecked() ? ColorPaletteUtils.getTransparentColor(color,100): getBackgroundColor(), PorterDuff.Mode.MULTIPLY);
    }
